...
var NginxCacheKill = function(site_configs, default_config){
    ...
    this.createRedisClients = function(){
        ...
        this.redisClient = new Spade( { socket: { address: { port: this.default_config.redis.port, host: this.default_config.redis.host}}});
        this.redisClient.on("connect", function(){
            logger.log('debug','redis connected'+this.redisClient);
        });
