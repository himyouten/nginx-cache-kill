...
var NginxCacheKill = function(site_configs, default_config){
    ...
    this.createRedisClients = function(){
        logger.log('debug', 'connecting to redis at %s:%s', this.default_config.redis.port, this.default_config.redis.host);
        ...
        logger.log('debug','redisClient at %s:%s', redisClient.host, redisClient.port);
    }
